...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_registr.setGeometry(QtCore.QRect(120, 60, 211, 71))
        font = QtGui.QFont()
...
"border-radius: 15px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_registr.setText(_translate("MainWindow", "ЗАПИСЬ ОКОНЧЕНА!"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MainWindow = QtWidgets.QMainWindow()
    RegistOver = Ui_MainWindow()
    RegistOver.setupUi(MainWindow)
    MainWindow.show()
    sys.exit(app.exec_())